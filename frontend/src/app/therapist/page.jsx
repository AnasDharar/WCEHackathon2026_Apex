  ...
  return (
    <div className="pb-20">
      <div className="flex justify-between items-end mb-8">
        <Header
          title="Practitioner Overview"
          subtitle="Here's a snapshot of your workload today."
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className={`${static_card_style} flex flex-col gap-2 relative overflow-hidden group`}>
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-gray-500">Patients</span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className={`md:col-span-8 ${static_card_style} flex flex-col`}>
          <div className="flex justify-between items-center mb-6">
             <h2 className="text-lg font-bold tracking-tight text-gray-900">Today's Schedule</h2>
             <Link href="/therapist/appointments" className="text-emerald-600 hover:text-emerald-700 font-semibold text-sm transition-colors">View All &rarr;</Link>
          </div>
            ...
            {todaysSchedule.length > 0 ? todaysSchedule.map(appt => (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-500 mt-1 font-medium">
                      <span className="flex items-center gap-1 bg-white px-2 py-0.5 rounded shadow-sm ring-1 ring-black/5"><Video className="w-3 h-3"/> {appt.mode || "Online"}</span>
                      {appt.status === "confirmed" && <span className="flex items-center gap-1 text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded shadow-sm ring-1 ring-emerald-200"><CheckCircle className="w-3 h-3"/> Confirmed</span>}
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full flex items-center justify-center p-8 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50/50">
                <div className="flex flex-col items-center flex-1 py-4">
                  ...
                  <span className="text-sm font-medium text-gray-500">No sessions scheduled today.</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
             <Link href="/therapist/messages" className="group flex items-center justify-between p-4 rounded-xl bg-gray-50 ring-1 ring-gray-100 hover:bg-emerald-50 hover:ring-emerald-100 transition-all">
               <div className="flex items-center gap-3">
                 ...
                 <span className="text-sm font-bold text-gray-700 group-hover:text-emerald-700">Inbox</span>
               </div>
